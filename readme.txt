...
===============================================================================
	...
	2. document/
		...
		2.22 How_to_enable_Realtek_RSON_function.pdf

	3. driver/
		3.1 rtl8723DU_WiFi_linux_v5.2.15.1_26226.20180129_COEX20171212-2222.tar.gz
			Naming rule: rtlCHIPS_WiFi_linux_vM.N.P[.H]_s.yyyymmdd_COEXyyyymmdd-aabb[_beta].tar.gz
			where:
				...
				N: miNor version
				P: Patch number
				H: (optional) Hotfix number
				s: SVN number
				yyyymmdd: Date
				y: release year
				m: release month
				d: release day
				COEX version: _COEXyyyymmdd-aabb
				(optional) BETA version: _beta
	...
	4. wpa_supplicant_hostapd/
		...
		4.5 wpa_supplicant_8_kk_4.4_rtw_r25669.20171213.tar.gz
		...
		4.9 wpa_supplicant_8_O_8.x_rtw_r24597.20171025.tar.gz
			wpa_supplicant_8 from Android 6.x SDK and patched by Realtek
			could be used for pure-linux and Android 6.x. Support only cfg80211/nl80211.	 
	...
	8. android_ref_codes_M_6.x/
		...
		8.2 realtek_wifi_SDK_for_android_L_6.x_20151116.tgz
			This tar ball includes our android wifi reference codes for Android 5.x
	...
	10. android_ref_codes_O_8.0/
		...
		10.2 realtek_wifi_SDK_for_android_O_8.0_20170925.tar.gz
			This tar ball includes our android wifi reference codes for Android 5.x
...
==================================================================================================================
			...
			(*) For Android 8.x, please refer to android_ref_codes_O_8.0/Realtek_Wi-Fi_SDK_for_Android_0_8.0.pdf
